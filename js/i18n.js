...
const STRINGS = {
  en: {
    ...
    autoZero: 'Auto-zero on straights', autoZeroHint: 'Long straight stretches (6 s+, above 30 km/h, no heading change) are assumed level; their median lean is removed from the calibration. Corrections are applied at the start of a straight and kept.',
    autoZeroed: 'Lean zero corrected by {d}°',
  ...
  it: {
    ...
    autoZero: 'Auto-zero sui rettilinei', autoZeroHint: 'I tratti lunghi in rettilineo (6 s+, oltre 30 km/h, direzione costante) vengono considerati a moto dritta; la loro piega mediana viene rimossa dalla calibrazione. Le correzioni si applicano all\u2019inizio di un rettilineo e restano memorizzate.',
    autoZeroed: 'Zero piega corretto di {d}°',
  ...
  en: {
    ...
    firstRide: {
      ...
      li: [
        ...
        'Auto-zero then refines it as you ride: long straights (6 s+, above 30 km/h, no heading change) are taken as level and their median lean is removed. Road camber can leave about 1°.',
        'Tap START at the bottom to record a session, STOP to end and save it. ⟳ in the title zeroes the live stats.',
  ...
  it: {
    ...
    firstRide: {
      ...
      li: [
        ...
        'L’auto-zero poi lo affina mentre guidi: i rettilinei lunghi (6 s+, oltre 30 km/h, direzione costante) sono considerati a moto dritta e la loro piega mediana viene rimossa. La pendenza della strada può lasciare circa 1°.',
        'Tocca START in basso per registrare una sessione, STOP per terminarla e salvarla. ⟳ nel titolo azzera le statistiche.',
